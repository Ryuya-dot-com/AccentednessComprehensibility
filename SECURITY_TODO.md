...
- [ ] Add security smoke tests.
  ...
  - Added guarded D1 schema updater: `node scripts/apply_d1_schema_updates.mjs --database accentedness-comprehensibility --apply --backup-before-apply` checks live columns, exports a SQL backup, and applies only missing additive columns.
