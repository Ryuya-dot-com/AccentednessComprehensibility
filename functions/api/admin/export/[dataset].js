  ...
  try {
    ...
    if (!wantsZip && !exportSpec) {
      return errorResponse(
        "Unknown export. Use all.zip, analysis.csv, ratings.csv, sessions.csv, assignments.csv, events.csv, counterbalance.csv, speaker-pattern-bundles.csv, word-familiarity.csv, or quality.csv.",
        404,
      );
    }
